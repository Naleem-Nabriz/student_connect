  ...
  if (!user || user.role !== 'admin') {
    return (
      <div className="text-center py-8">
        <p className="text-[#b85f47]">Access denied. Admin privileges required.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 rounded-[28px] border border-[#d8e4e6] bg-[#fffaf2] p-5 shadow-[0_18px_45px_rgba(61,61,61,0.06)] md:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-[#3D3D3D]">Admin Dashboard</h1>
          <p className="mt-2 text-sm text-[#62574d]">Review, approve, and manage all kuppi advertisements.</p>
        </div>
      </div>
      ...
      <div className="mb-6 rounded-[24px] border border-[#eadfce] bg-white/85 p-4 shadow-[0_16px_35px_rgba(61,61,61,0.08)]">
        <h2 className="mb-4 text-lg font-semibold text-[#3D3D3D]">Advertisement Status</h2>
        <div className="grid grid-cols-4 gap-4 text-center">
          <div className="rounded-[20px] bg-[#efe4d8] p-4">
            <div className="text-2xl font-bold text-[#62574d]">{ads.length}</div>
            <div className="mt-1 text-sm text-[#62574d]">Total Ads</div>
          </div>
          <div className="rounded-[20px] bg-[#fff1cc] p-4">
            ...
            <div className="text-xs text-[#a88619]">Need approval</div>
          </div>
          <div className="rounded-[20px] bg-[#d9ecf7] p-4">
            ...
            <div className="text-xs text-[#2d7aa4]">Visible to students</div>
          </div>
          <div className="rounded-[20px] bg-[#f6e3dc] p-4">
            ...
            <div className="text-xs text-[#c66f57]">Not visible</div>
          </div>
        </div>
      </div>
